            ...
            <>
              ...
              <div className="bg-white p-2 rounded-[1rem] border border-slate-100 shadow-sm space-y-4">
                <div>
                  ...
                  <div className="border border-slate-200 rounded-[1rem] shadow-sm">
                    <table className="w-full text-left border-collapse bg-white">
                      <thead>
                        <tr className="bg-slate-900 text-white">
                ...
                <table className="w-full table-auto text-left border-collapse bg-white break-words">
                  ...
                  <thead>
                    <tr className="bg-slate-900 text-white">
                      ...
                      <th
                        className="p-1 text-[10px] font-black uppercase tracking-widest cursor-pointer group hover:bg-slate-800 transition-colors whitespace-normal break-words"
                      ...
                      <th
                        className="p-2 text-[10px] font-black uppercase tracking-widest text-right cursor-pointer group hover:bg-slate-800 transition-colors whitespace-normal break-words"
                      ...
                      <th className="p-2 text-[10px] font-black uppercase tracking-widest text-right whitespace-normal break-words">
                        <div className="flex items-center justify-end">
                          Peso (KG)
                        </div>
                      </th>
                      ...
                      <th className="p-2 text-[10px] font-black uppercase tracking-widest text-right cursor-pointer group hover:bg-slate-800 transition-colors whitespace-normal break-words">
                        <div className="flex items-center justify-end">
                          Multipacotes (R$)
                        </div>
                      </th>
                      ...
                      <th
                        className="p-1 text-[10px] font-black uppercase tracking-widest text-center cursor-pointer group hover:bg-slate-800 transition-colors whitespace-normal break-words"
                  ...
                  <tbody className="divide-y divide-slate-100">
                    {allRoutesSummaryPro.map((route, idx) => (
                      ...
                      >
                        <td className="p-1 text-center whitespace-normal break-words">
                          <select
                            value={route.vehicle}
                            onChange={(event) => {
                        ...
                        <td className="p-1 text-right whitespace-normal break-words">
