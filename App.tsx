  ...
  return (
    <div className="w-full h-full relative flex flex-col bg-slate-50 overflow-hidden font-sans text-slate-900">
      ...
      <div className="absolute top-8 left-1/2 -translate-x-1/2 z-[2000] w-[95%] max-w-6xl">
        <div className="bg-white/95 backdrop-blur-3xl p-3 rounded-[3rem] shadow-[0_20px_50px_-10px_rgba(0,0,0,0.15)] flex flex-wrap md:flex-nowrap items-center gap-3 border border-white/40">
      ...
      >
        ...
        {activeDriverData ? (
          <div className="space-y-6">
            <div className="bg-slate-900 p-4 rounded-[3rem] text-white shadow-xl border border-white/10">
        ...
        <div className="space-y-6">
          {selectedRoute !== ALL_VALUE ? (
            (() => {
              ...
              return (
                <div className="space-y-4 pb-4">
                  <div className="bg-slate-900 p-8 rounded-[3rem] text-white shadow-xl border border-white/10 relative overflow-hidden group">
            ...
            <div className="space-y-4">
              <div className="bg-indigo-600 p-4 rounded-[3rem] text-white shadow-xl">
